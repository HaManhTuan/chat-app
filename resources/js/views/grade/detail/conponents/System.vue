<template>
  <div class="student-detail body-content">
    <el-form ref="formData" class="search card-body scroll-content" label-width="123px" :rules="searchRules" :model="formData">
      <h3>
        システム
      </h3>
      <!-- FIRST ROW -->
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="修正日" label-width="115px">
            <el-date-picker
        ...
        <el-col :span="8">
          <el-form-item label="ステータス" prop="status" label-width="94px">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="修正者" label-width="115px">
            <el-select
