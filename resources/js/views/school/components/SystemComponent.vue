        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label-width="95px" label="作成者">
              <el-select
                v-model="formData.created_by_user_id"
                placeholder=""
              ...
              >
                <el-option
                  v-for="item in [formData.user?formData.user:{}]"
                  :key="item.id"
                  :label="item.name"
                  :value="item.id"
                />
          ...
          <el-col :span="8">
            <el-form-item label-width="113px" label="修正者">
              <el-select
                v-model="formData.modified_by_user_id"
                placeholder=""
                :no-data-text="CommonTxt.selectboxEmptyTxt"
                clearable
                filterable
              ...
              >
                <el-option
                  v-for="item in [formData.edit_user?formData.edit_user:{}]"
                  :key="item.id"
                  :label="item.name"
                  :value="item.id"
                />
